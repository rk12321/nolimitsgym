      ...
      <div class="card text-center">
         <div class="card-header p-4 d-lg-block d-none" style="background:aliceblue;">
            <h6 class="text-right"> <span class="ml-5" style="cursor:pointer;">   HOME
               ...
               <span class="ml-5" style="cursor:pointer;"><a href="login.php" style="color:black; text-decoration:none;">LOGIN</a></span>
            </h6>
         </div>
    ...
    <h4 class="text-success">NO LIMITS GYM</h4>
      ...
      <a href="login.php"><li>Login</li></a>
         ...
         <div class="card-body " style="border:none;">
            <div class="card" data-aos="zoom-in" data-aos-duration="1000" style="border:none;">
               <img src="img/img1.png" class="d-lg-block d-none" style="height:100vh;" alt="">
               <img src="img/img1.png" class="d-block d-lg-none" style="height:30vh;" alt="">
            </div>
            <div class="mt-5 mb-3 my-lg-5 my-0">
               <div class="row">
         ...
         <div class="card-footer py-4 text-muted" style="background:ghostwhite;">
            <div class="row">
               ...
               <div class="col-lg-3 col-6 d-lg-block d-none">
                  <h6 class="mb-4">JOIN OUR NEWSLETTER</h6>
                  <input type="text" style="" placeholder="your email here">
                  <h6 class="mt-2"><a class="btn btn-success" href="#">Subscribe</a></h6>
               </div>
            </div>
         </div>
